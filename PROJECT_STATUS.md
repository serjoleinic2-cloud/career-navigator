...
**Обновил:** Claude (двенадцатая сессия — World Progression Rework: одна активная глава вместо списка карточек)
**Последний коммит на момент записи:** `e7e3aca` (main, до этой сессии)

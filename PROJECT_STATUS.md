...
**Обновил:** Claude (восьмая сессия — пользователь сообщил, что кнопка Save в Notes всё ещё под меню после манифест-фикса; добавлен независимый JS-фикс через visualViewport)
**Последний коммит на момент записи:** `b7c972f` (main, до этой сессии)
